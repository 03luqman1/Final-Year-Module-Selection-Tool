...
public class CreateStudentProfilePane extends GridPane {
	...
	// method to output message to the user
	public void setMessage(String msg) {
		lblMessage.setText(msg);
	}

	// method to populate the form with data
	public void setFields(String fName, String sName, String email, String pNum, LocalDate date, int course) {
