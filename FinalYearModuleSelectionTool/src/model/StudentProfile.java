...
public class StudentProfile implements Serializable {
	...
	public String getStudentSurname() {
		return studentName.getFamilyName();
	}
	...
	public String toString() {
		return "StudentProfile:[Pnumber=" + studentPnumber + ", studentName=" + studentName + ", studentEmail="
				+ studentEmail + ", studentDate=" + studentDate + ", studentCourse=" + studentCourse.actualToString()
				+ ", selectedModules=" + selectedModules + ", reservedModules=" + reservedModules + "]";
	}
